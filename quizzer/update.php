...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Update question in questions table
    $sql = "UPDATE question SET option_a='$option1', option_b='$option2', option_c='$option3', option_d='$option4', answer='$answer' WHERE question_text='$question_text'";
    if (mysqli_query($conn, $sql)) {
        $success = true; // Question successfully updated
    }
}
?>
...
<script>
    // PHP variable to check if question was successfully updated
    <?php if($success): ?>
        alert("Question successfully updated!"); // Show popup alert if question was successfully updated
    <?php endif; ?>
</script>
</body>
</html>
